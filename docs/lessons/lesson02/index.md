...
生まれつき色の見え方が異なる状態です。網膜の錐体（色を感じる細胞）の一部が機能しない、または異なる感度を持っていることで起きます。色覚特性には主に **P型（1型）・D型（2型）・T型（3型）・A型** の分類があり、その大半は赤緑系の区別が困難な P型・D型です（詳細は [lesson13](/lessons/lesson13/)）。
