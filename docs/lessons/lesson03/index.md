# lesson03: 色の機能的役割と情緒的役割

## このレッスンで学ぶこと

- 色の役割が「機能的役割」と「情緒的役割」の2種類に分かれることを理解する
- 誘目性・視認性・可読性・識別性の定義と違いを説明できるようになる
...
機能的役割とは、色が情報を正確・効率的に伝えるために果たす役割です。代表的な4つの機能をしっかり覚えましょう。
...
**対象物が見つかりやすく、識別しやすい力**のことです。明度差（明るさの差）が大きいほど視認性は高くなります。

- 背景と対象物の明度差が大きいほど見やすくなる
- 白地に黒文字は最も視認性が高い組み合わせのひとつ
- 夜間の標識（黒地に黄文字）も明度差を活かしている

**例**: 白地に黒のゼブラ横断歩道、黒地に白抜き文字のメニュー表

::: warning 視認性と色覚特性
視認性を高めるには**明度差を意識することが重要**です。色相が違っても明度差が小さいと、色覚特性のある人には区別できないことがあります。
:::
...
| 機能 | 定義 | 主なポイント | 代表例 |
|------|------|-------------|--------|
| 誘目性 | 注意を引きつける力 | 彩度が高い色・暖色系が有利 | 非常口サイン・警告表示 |
| 視認性 | 見つけやすさ・識別しやすさ | 明度差が大きいほど高い | 白地に黒文字・夜間標識 |
| 可読性 | 文字・図形の読みやすさ | コントラスト比を十分に確保する | 書籍の本文・UI画面 |
...
| 用語 | 説明 |
|------|------|
| 機能的役割 | 色が情報を正確・効率的に伝える役割。誘目性・視認性・可読性・識別性が代表的 |
| 情緒的役割 | 色が感情・印象・イメージを伝える役割。ブランドイメージや感情表現に使われる |
| 誘目性 | 意識しなくても自然と注意を引きつける力。彩度の高い暖色系が強い |
| 視認性 | 対象が見つかりやすく識別しやすい力。明度差が大きいほど高い |
| 可読性 | 文字や図形が読み取りやすい力。コントラスト比が重要 |
...
- **誘目性・視認性・可読性・識別性の定義と違い**を区別して覚える（特に「誘目性」と「視認性」は混同しやすい）
- **誘目性は彩度**が関係し、**視認性・可読性は明度差**が関係する
