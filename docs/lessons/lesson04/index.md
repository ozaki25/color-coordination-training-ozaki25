# lesson04: 色とは・光とは — 色を生み出す光の正体

## このレッスンで学ぶこと

- 色が「光」によって生まれることを理解する
- 電磁波の種類と可視光線の位置づけを理解する
- 可視光線の波長範囲（380〜780nm）と色の対応を覚える
- プリズムによる分光の仕組みを理解する
- 物体の色がどのように見えるのかを説明できる

## 色は「光」から生まれる

色を理解するには、まず「光」について知る必要があります。**光がなければ色は存在しない**ためです。
...
このうち光が目に届く範囲が可視光線で、その波長がこれから学ぶ380〜780nmです。
...
この数値は試験に頻出です。「380〜780」という数字は確実に覚えましょう。
:::

可視光線の中でも、波長の違いによって異なる色として知覚されます。

![可視光線のスペクトル。約380nmの紫から780nmの赤まで、波長と色が対応する帯。短波長側が紫・青、長波長側が赤。](/diagrams/visible-spectrum.svg)
...
::: tip 光の色（加法混色）と物体の色
光自体の色（モニターや照明など）は「加法混色」といい、光を足すほど明るくなります（赤＋緑＋青＝白）。物体の色（絵の具・印刷など）は「減法混色」といい、色を混ぜるほど暗くなります。光は「足し算」、絵の具は「引き算」のように、混色のしくみが逆向きです。
:::
...
- 赤・緑・青（RGB）は光の三原色で加法混色、シアン・マゼンタ・イエロー（CMY）は絵の具・印刷の三原色で減法混色
