...
瞳孔を囲む筋肉の膜で、瞳孔の大きさを調節します。日本人では茶や黒に見える部分です。

### 水晶体（すいしょうたい）

眼の中にあるレンズです。厚みを変えることでピントを調節します（カメラのオートフォーカス機構に相当）。

- **近くを見るとき**: 水晶体が厚くなる（毛様体筋が収縮）
- **遠くを見るとき**: 水晶体が薄くなる（毛様体筋が弛緩）

::: warning 老眼と水晶体
加齢とともに水晶体の**弾力が低下**し、ピント調節がしにくくなります。これが**老眼（老視）**の原因です。また、高齢になると水晶体が**黄変（黄みがかる）**することで、青・紫系の色が見えにくくなります。これは色のUDに深く関係します。詳しくは[lesson22](/lessons/lesson22/)で学びます。
:::
...
網膜には2種類の感光細胞があります。ここでは概要をつかみ、詳しくは[lesson07](/lessons/lesson07/)で学びます。
...
::: tip 錐体が3種類ある
錐体にはさらにL錐体（長波長＝赤系）・M錐体（中波長＝緑系）・S錐体（短波長＝青系）の3種類があり、それぞれ異なる波長の光に反応します。先天性色覚特性は、L・M・S錐体のいずれかに変化があることで起きます。詳しくは[lesson07](/lessons/lesson07/)で学びます。
:::
...
網膜で変換された電気信号を脳に伝える神経です。視神経が損傷すると視野欠損や色覚変化が起きることがあります（緑内障では視神経が損傷します）。
...
- いずれも、目に入った光の情報が網膜や神経で本来どおりに受け取られない・伝わらないことで、色の見え方に影響します
:::
