...
| L錐体（Long） | 長波長（約560nm付近） | 赤〜黄系の光 |

::: tip 「SML」で覚えよう
S=Short（短波長・青）、M=Medium（中波長・緑）、L=Long（長波長・赤）。「SML＝青・緑・赤」と対応させて覚えておきましょう。
:::
...
| 用語 | 説明 |
|------|------|
| 錐体（Cone） | 色と形を識別する視細胞。黄斑・中心窩に集中し、明所視で機能する |
| 桿体（Rod） | 明暗を識別する視細胞。網膜周辺部に分布し、暗所視で機能する。色は識別しない |
