...
- 対立色説（ヘリング）の概要を把握する
- 色覚異常の種類（P型・D型・T型・A型）と欠損する錐体の対応を理解する
- 色の恒常性の意味を知る
...
3種類の錐体の信号が脳に届いた後、さらに**対立色（反対色）**の信号に変換される処理が行われます。これを**対立色説（opponent-color theory）**といい、19世紀の生理学者エワルト・ヘリング（Ewald Hering）が提唱しました。
...
3種類の錐体のいずれかが欠損・機能不全になると、色の見え方が一般的なC型色覚とは異なります。これを**色覚異常**（色覚特性と呼ぶこともあります）といいます。

::: warning 「異常」という言葉について
「色覚異常」は医学的・検定試験上の用語です。実際の生活では多くの方がほとんど不便なく暮らしており、近年は「色覚特性」「色覚多様性」という言葉も使われています。UC級では配慮ある設計を学ぶことが目的です。
:::
...
日本人男性の約5%（20人に1人）、女性の約0.2%が色覚異常に相当します。つまり、ある程度の人数が集まった会議室や電車の中には、必ず色覚特性をもつ人がいると考えるべきです。UC（色のユニバーサルデザイン）を実践する理由がここにあります。
...
- 色覚異常の種類と欠損する錐体の対応：**P型=L錐体、D型=M錐体、T型=S錐体**
- P型とD型はどちらも「赤・緑の区別が困難」、T型は「青・黄の区別が困難」
- 日本人男性の約5%（約20人に1人）に色覚異常があることを覚えておく
- **対立色説（ヘリング）**：赤-緑、青-黄、白-黒の3対の対立信号
