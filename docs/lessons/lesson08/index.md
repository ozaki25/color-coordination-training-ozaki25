# lesson08: 3色型色覚のしくみ — S・M・L錐体と色の感知
...
[lesson07](/lessons/lesson07/)で、網膜には3種類の錐体（S・M・L）があることを学びました。このレッスンでは、それら3種類の錐体がどのように組み合わさって「色の知覚」を生み出しているかを詳しく見ていきます。
...
色覚の分類では、一般的な3色型色覚を「C型色覚（Conventional type）」と呼ぶことがあります。日本人男性の約95%、女性の約99.8%がC型色覚です。
:::
...
P型（1型）・D型（2型）はどちらも赤と緑の区別が困難ですが、色の見え方の歪み方には違いがあります。詳しくは [lesson14](/lessons/lesson14/)・[lesson15](/lessons/lesson15/) で学びます。
