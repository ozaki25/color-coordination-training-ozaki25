...
::: info 「色盲」という言葉について
「色盲（しきもう）」「色弱（しきじゃく）」という言葉は、かつて医療・教育の現場で広く使われていましたが、当事者に不必要な劣等感を与えることから、現在は**「色覚特性」「色覚の多様性」**という表現が推奨されています。試験でもこの考え方が反映されています。
:::
...
**錐体がほとんど機能しない**タイプです。色を識別することができず、世界が白黒（グレースケール）に見えます。光に対する過敏さ（羞明）を伴うことも多いです。非常にまれな色覚特性です。
