...
- 日本における色覚特性者の統計（頻度）を把握する
- 先天性・後天性の違いと、UCデザインが必要な理由を理解する
...
::: info 用語の使い分け（色覚異常・色覚特性・色覚の多様性）
**「色覚異常」**は、眼科などで使われる医学用語です。一方、**「色盲」「色弱」**は、かつて広く使われた言葉です。これらは当事者に不必要な劣等感を与えることから、現在は避けられています。

本コンテンツでは、見え方の違いを多様性として捉える立場をとります。呼称としては**「色覚特性」**、その考え方としては**「色覚の多様性」**を基本表記とします。試験でもこの考え方が反映されています。
:::
...
### A型（全色盲 / Achromatopsia）

**錐体がほとんど機能しない**タイプです。色を識別できず、世界が白黒（グレースケール）に見えます。光に対する過敏さ（羞明）を伴うことも多いです。非常にまれな色覚特性です。
...
D型に関わるM錐体の遺伝子は、P型に関わるL錐体の遺伝子と構造がよく似ており、X染色体上で隣り合っています。この類似から遺伝子の組み換えエラーが起きやすく、結果としてD型が多くなると考えられています。詳しくは [lesson14](/lessons/lesson14/) で解説します。
:::
