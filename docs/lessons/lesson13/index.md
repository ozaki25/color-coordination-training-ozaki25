# lesson13: P型色覚（1型色覚）の見え方と混同しやすい色
...
なお、P型・D型が先天性（X染色体連鎖の遺伝）であるのに対し、T型（3型）は後天性・加齢によるものが多く、高齢者の見え方（[lesson17](/lessons/lesson17/)）とも関連します。P型・D型・T型の位置づけをあわせて押さえておきましょう。
