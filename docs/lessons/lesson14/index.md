...
D型（Deuteranomaly）が最も多い理由は遺伝子の構造にあります。M錐体の遺伝子（OPN1MW遺伝子）はL錐体の遺伝子（OPN1LW遺伝子）と非常に似ており、X染色体上で隣接して存在します。この類似性から**遺伝子の組み換えエラーが起きやすく**、M錐体に影響する変異が生じやすいと考えられています。
