...
| 要素 | 説明 |
|------|------|
| X軸（x値） | 赤みの強さを表す。右に行くほど赤みが強い |
| Y軸（y値） | 緑みの強さを表す。上に行くほど緑みが強い |
...
::: warning 重要な意味
**混同色線上にある2つの色は、その色覚タイプの人には「同じ色」として見えます。** どんなに明確に異なる色名であっても、混同色線上にあれば区別できない場合があります。
:::
...
- 混同色線上の2色は「その色覚タイプには同じ色に見える」という意味を押さえる
