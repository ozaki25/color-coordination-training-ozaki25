...
[lesson14](/lessons/lesson14/)・[lesson15](/lessons/lesson15/) では、P型・D型の人が赤と緑を混同しやすいことを具体例で学びました。「なぜそうなるのか」を科学的に説明するための道具が、これから学ぶ**色度図**と**混同色線**です。色度図は色を平面に配置した「色の地図」で、その地図の上に「同じ色に見えてしまう色を結んだ直線」を引いたものが混同色線です。
...
色度図は、どの色とどの色が区別しにくいかを視覚的に捉えるための「色の地図」です。色覚特性のある人が見分けにくい色の関係（混同色線）を理解するために使います。まずは地図の読み方として、図の構造から押さえていきましょう。
