# lesson17: 加齢による視機能の変化 — 高齢者の見え方を知る
...
水晶体が加齢とともに**黄変（おうへん）**することで、短波長の光（青系）が吸収されやすくなります。詳細は次のlesson18で扱いますが、「青が暗く見える」「青と黒の区別がつきにくくなる」という変化が起きます。

### 4. 暗順応の遅れ

**暗順応**とは、明るい場所から暗い場所に入ったときに目が慣れるプロセスのことです。このプロセスを担うのは、網膜の**桿体（かんたい）**という光受容細胞です。

加齢により桿体の感度が低下すると、暗順応に時間がかかるようになります。映画館に入った直後、夜間の外出など「明→暗」の場面で見えにくくなります。
...
上記の6つの変化はどれも大切です。なかでも**色のUD**の観点では、次の3つを優先して押さえましょう。
...
::: tip 各論への導線
水晶体の黄変は詳しくは [lesson18](/lessons/lesson18/)、グレアと暗順応は [lesson19](/lessons/lesson19/) で学びます。本レッスンは総論、lesson18・lesson19が各論という位置づけです。
:::
...
| 暗順応 | 明るい場所から暗い場所に入ったときに目が慣れるプロセス。桿体が担う |
...
- 加齢による視機能の変化は**6種類**をまとめて押さえる：視力低下・コントラスト感度低下・色覚変化（青系）・暗順応の遅れ・グレア感受性増大・視野の狭まり
