...
- 進学・就職での扱いの歴史的経緯を理解する
- 学校健診での色覚検査の廃止と再開の流れを理解する
...
::: tip 信号機の点灯位置の意義
日本の信号機は横型が標準で、縦型は雪が積もりにくいよう積雪地域などで使われます。縦型・横型のどちらも点灯位置が固定されている（縦型は上＝赤・下＝青、横型は右＝赤・左＝青）ため、色が区別しにくくても**位置情報で判断できる**設計になっています。
:::
...
- **赤や緑のチョーク**は、黒板の上ではP型・D型の子どもには見えにくい
