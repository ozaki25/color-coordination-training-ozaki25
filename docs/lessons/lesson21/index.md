...
白（最も明るい）と黒（最も暗い）の組み合わせが最大の明度差を持ち、視認性は最高です。一方、明度が近い同士の組み合わせ（例: 薄いグレーと白）はコントラストが低く、見えにくくなります。
...
「補色は色相差が最大なので、最も見やすい組み合わせのはず」と思われるかもしれません。しかし、**赤と緑は補色でありながら、P型・D型の色覚特性者には区別が非常に困難** です。

この理由は、P型・D型では赤〜緑の波長範囲を識別するための視細胞の機能に違いがあるためです。色相差が大きくても、その色相差の「種類」によっては色覚特性者に伝わらない場合があります。
...
「補色を使えば見やすくなる」は正しいですが、赤と緑の組み合わせは例外です。色相差の活用と合わせて、明度差の確保や色以外の手がかりの追加が必須です。
:::
...
| 補色 | 色相環で正反対の位置にある色。最大の色相差を持つが赤と緑は混同に注意 |
| P型・D型 | 赤〜緑の範囲で色の識別が難しい色覚特性。日本人男性の約5% |
...
- **赤と緑は補色（最大の色相差）だが、P/D型には区別が難しい** という矛盾するような例外を押さえる
