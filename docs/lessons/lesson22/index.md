...
- 水晶体の黄変（おうへん）により短波長（青系）の透過率が低下する仕組みを理解する
- 加齢で見分けにくくなる色の組み合わせ（青と黒、青と紫、白と黄など）を把握する
- グレアの2種類（不能グレア・不快グレア）と、加齢でグレアが増す理由を説明できる
- コントラスト感度の低下が日常に与える影響を整理する
- 高齢者に配慮した照明・配色の基本方針を身につける

[lesson21](/lessons/lesson21/)で扱った加齢による視機能の変化のうち、本レッスンでは **色の弁別機能** と **まぶしさ・コントラスト感** の2つに焦点を当てます。公式テキスト5-2に対応する内容です。
...
**水晶体（すいしょうたい）** は目の中でピント調節を担うレンズ状の透明組織です。主成分は **クリスタリン** というタンパク質で、加齢とともに次のように変化します。
...
この変化は20代後半から少しずつ始まり、60〜70代以降に顕著になります。紫外線は黄変を促進するため、屋外活動が多い人ほど進みやすい傾向があります。

### 短波長の透過率低下

水晶体が黄みがかると、**短波長（400〜450nm付近）の青系の光** が水晶体に吸収されやすくなります。これは、変性したクリスタリンが黄褐色を呈する物質に変わり、その分光吸収特性として短波長の光を強く吸収するためです。吸収の結果として、人の目には水晶体が黄みがかって見える（黄と青は補色の関係にあるため、青の補色として黄に知覚される）という関係になります。

結果として、網膜に届く青系の光が大きく減り、青の色相を見分ける感度が低下します。長波長側（赤・橙系）への影響は比較的小さいため、青系だけが暗くくすんで見えるという偏りが生じます。
...
| 比較 | 黄変 | 白内障 |
|------|------|--------|
| 変化の内容 | タンパク質の着色（黄〜褐色） | タンパク質の凝集による白濁 |
| 主な症状 | 青系の色の識別困難 | 視力低下・かすみ・グレア増大 |
| 関係 | 黄変が進むと白内障に移行することがある | 白内障は黄変が進んだ状態とも言える |
...
WCAG AA の基準は標準テキストで4.5:1以上ですが、高齢者向けの掲示や案内では **より高いコントラスト比（7:1以上）** を確保すると安心です。詳しくは[lesson27](/lessons/lesson27/)・[lesson28](/lessons/lesson28/)で扱います。
:::
...
| 用語 | 説明 |
|------|------|
| 水晶体（すいしょうたい） | 目の中でピント調節を担うレンズ状の透明組織。主成分はクリスタリン |
...
- 黄変の原因はクリスタリンの **変性・凝集と黄褐色への着色**。黄褐色になった水晶体が短波長（青系）の光を吸収する（黄と青が補色関係にあるのは、青を吸収する物質が黄に見えるという結果）
