# lesson23: 推奨配色セットと身の回りの配色事例

## このレッスンで学ぶこと

- カラーユニバーサルデザイン推奨配色セット（アクセント9・ベース7・無彩色4＝20色）の構成と役割を理解する
- 学んだUD配色の知識を「身の回りのデザインを評価する目」として活かす
...
事例に入る前に、UD配色を実践するうえで広く参照されている**カラーユニバーサルデザイン推奨配色セット**を押さえます。NPO法人カラーユニバーサルデザイン機構（CUDO）が制定したカラーパレットで、**色覚特性のある人にも見分けやすい色の組み合わせ**を体系的に提供しています。
...
| **ベースカラー** | 7 | 高明度・低彩度 | 背景や塗りつぶしなど**広い面積** |
| **無彩色** | 4 | 白・グレー・黒 | 他の色と組み合わせ、コントラスト調整 |

合計 **9 + 7 + 4 = 20 色**（塗装用の代替色 2 色を含めると 22 色）です。試験ではこの色数の構成も問われやすいので押さえておきます。

::: tip 「アクセント＝高彩度・小面積」「ベース＝高明度低彩度・広面積」
逆に使うと（広い面積に高彩度のアクセントを敷くなど）目が疲れたり、文字が読みにくくなったりします。**役割と面積の関係**で覚えると整理しやすくなります。
:::

::: info この配色セットの意義
推奨配色セットは「迷ったときに頼れる確実な選択肢」です。実際の業務やデザインでブランドカラーの制約があるときも、**この20色のなかから選ぶ・近づける**だけで色のUD品質を底上げできます。
:::
...
| アクセントカラー（9色） | 高彩度。文字・線・マーカーなど小面積に使う：赤・黄・緑・青・空色・ピンク・オレンジ・紫・茶 |
| ベースカラー（7色） | 高明度・低彩度。背景など広い面積に使う：明るいピンク・クリーム・明るい黄緑・明るい緑・明るい空色・明るい紫・ベージュ |
...
- **アクセントカラーは高彩度・小面積向き**（文字・線・マーカー）、**ベースカラーは高明度低彩度・広い面積向き**（背景）
- アクセント9色は「赤・黄・緑・青・空色・ピンク・オレンジ・紫・茶」を覚える
