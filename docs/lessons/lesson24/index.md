# lesson24: 色のUD設計プロセス — 計画から実施まで

## このレッスンで学ぶこと

- 「良い意図」だけではUDは実現しない理由と、体系的なプロセスの重要性を理解する
- 色のUD設計の5ステップ（現状把握→問題洗い出し→改善案策定→シミュレーション→実施・評価）を覚える
- 各ステップで具体的に何をすべきかを把握する
- UDは「一度やれば終わり」ではなく継続的な改善であることを理解する
- 設計の初期段階から組み込むことのメリットを知る

## 「良い意図」だけではUDは実現しない

「色覚特性のある人のために配慮したい」という思いを持っている人は増えています。しかし、善意や意識だけでは、具体的な成果につながらないことがほとんどです。

なぜでしょうか。それは、**色のUDを実現するには、意識だけでなく具体的な手順（プロセス）が必要**だからです。「なんとなく目立つ色にした」「明るい色を使った」といった感覚的な判断では、意図せず見えにくい組み合わせを選んでしまうことがあります。
...
- **色覚シミュレーターで確認する**: P型・D型・T型の見え方をシミュレーションします（具体的なツールはlesson25で詳しく解説）
