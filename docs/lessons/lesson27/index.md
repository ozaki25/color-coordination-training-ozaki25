...
- **P型（1型）**：L錐体の異常。赤みの知覚が弱い。日本人男性の約1.5%
- **D型（2型）**：M錐体の異常。緑みの知覚が弱い。日本人男性の約3.5%（最も多い）
- **T型（3型）**：S錐体の異常。青みの知覚が弱い。非常にまれ（先天性はごく少数）
- **P型・D型が混同しやすい色**：赤と緑、赤とオレンジ、緑と茶色、赤と黒
- **T型が混同しやすい色**：青と黄、紫と薄い黄緑
- **混同色線**：色度図上で、特定の色覚特性の人が「同じ色」として知覚してしまう色を結んだ直線

::: warning 試験に出る数値
- 日本人男性の**約5%**（20人に1人。P型＋D型がほとんど）が色覚特性者
- 女性は**約0.2%**（500人に1人）
- 内訳は P型**約1.5%**、D型**約3.5%**（D型のほうが多い）
- T型は**非常にまれ**
:::
...
- **明順応・暗順応の遅れ**：明順応＝暗→明（主に錐体）、暗順応＝明→暗（主に桿体）。加齢でいずれも時間がかかるようになる。とくに「明→暗」の暗順応の遅れが顕著
...
- **カラーUD推奨配色セット**（NPO法人CUDO制定）：アクセント9色＋ベース7色＋無彩色4色＝**合計20色**。アクセント＝高彩度・小面積、ベース＝高明度低彩度・広面積
...
26. カラーUD推奨配色セットの構成（アクセント9・ベース7・無彩色4＝20色）を言えるか
...
- **日本人男性の約5%**（P型＋D型）、女性の約0.2%、T型は**非常にまれ**
