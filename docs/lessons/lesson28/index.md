# lesson28: 配色の修正 — 見えにくい配色を改善する具体的な手法
...
P型（1型）・D型（2型）に混同されやすい代表的な組み合わせは「赤と緑」です。赤と緑は色相環で離れた関係にありますが、その色相差はP型・D型には認識されにくいため混同されます（[lesson28](/lessons/lesson28/)参照）。この組み合わせを解消するには、次のような方向性で色相を変えます。
