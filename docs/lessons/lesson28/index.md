...
並び順や配置で意味を伝える手法です。**信号機**は赤・黄・青（緑）の点灯位置が決まっている（日本で多い横型は右から赤・黄・青）ため、色が区別できなくても意味が分かります。
...
信号機は点灯位置が決まっています。日本で多い横型は「右が赤、左が青（緑）」の並びが国際的にほぼ統一されています。色の区別が難しい場合でも、**位置**で信号の意味を判断できます。
...
| 信号機の点灯位置 | 横型は右から赤・黄・青（緑）と並びが固定。位置で意味を伝える色のUD設計の例 |
| WCAG 1.4.1 | 「色の使用」規定。色だけで情報を伝えてはいけないというアクセシビリティ基準 |

## 試験のポイント

- 色のUDの設計・修正の4ポイント: **①区別しやすい色 ②明度差 ③色名付記 ④色以外の要素**
- **CUDO推奨配色セット**は20色(アクセント9・ベース7・無彩色4)
- アクセントカラー9色: **赤・黄・緑・青・空色・ピンク・オレンジ・紫・茶**
- **アクセント＝高彩度・小面積／ベース＝高明度低彩度・広面積**
- **明度差が最重要**。グレースケール変換で確認できる
- **WCAG AA**: 標準テキスト **4.5:1以上**、大きな文字・図形要素 **3:1以上**
- 色以外の手法の信頼性は **テキスト＞形＞パターン＞位置** の順
- **道路標識**(三角・丸・四角)、**信号機の点灯位置**(位置)、**路線図**(番号+色)は頻出改善事例
