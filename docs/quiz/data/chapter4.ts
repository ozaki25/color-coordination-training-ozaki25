...
export const chapter4: Quiz[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      "色覚特性のある子だけに別の課題やプリントを用意して個別対応する",
    ],
    answer: 0,
    explanation:
      "赤マークだけで重要箇所を示すのは、色覚特性のある子どもには黒文字と区別しにくく不適切です。一方、当事者だけに別課題を用意するのも一見配慮のようで、特別扱いになり子どもの主体性を損なうため望ましくありません。全員が同じ教材で困らないよう設計するのが色のUDの基本です。",
  },
];
