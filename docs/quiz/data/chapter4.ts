...
export const chapter4: Quiz[] = [
  ...
  },
  {
    ...
    difficulty: "normal",
    question:
      "P型・D型の人にも比較的混同されにくい色の組み合わせはどれですか。",
    choices: [
      "赤と緑",
      "青とオレンジ",
      "緑と茶",
    ...
    answer: 1,
    explanation:
      "青とオレンジは色相も明度も離れており、P型・D型にも比較的区別しやすい組み合わせです。赤と緑、緑と茶、赤とオレンジはいずれも混同しやすい組み合わせです。ただしどの配色でも明度差の確保は重要です。",
  },
  {
    id: "q412",
    lesson: "lesson16",
  ...
  },
  {
    ...
    lesson: "lesson16",
    difficulty: "normal",
    question: "P型・D型の混同色線の特徴として正しいものはどれですか。",
    choices: [
      "P型とD型では混同しやすい色の傾向がまったく異なる",
      "P型・D型とも長波長（赤）方向に向かい、赤と緑の区別が困難になる",
      "P型・D型とも短波長（青）方向に向かい、青と黄の区別が困難になる",
      "混同色線はT型にしか存在しない",
    ],
    answer: 1,
    explanation: "P型・D型の混同色線はどちらも長波長（赤）方向に向かい、収束点が近いため、赤と緑の混同という似た傾向を示します。短波長（青）方向に向かうのはT型です。",
  },
  {
    id: "q415",
    lesson: "lesson17",
  ...
  },
  {
    ...
    choices: [
      "重要語句を赤マークだけで示す",
      "色名を言葉でも添え、色だけに頼らず情報を伝える",
      "本人が自分の色覚特性に気づいていない場合があると理解しておく",
      "色だけでなく、形や記号、文字を組み合わせてプリントを作る",
    ],
    answer: 0,
    explanation:
      "赤マークだけで重要箇所を示すのは、色覚特性のある子どもには黒文字と区別しにくく不適切です。色名の併記、本人の気づきへの理解、色以外の手がかりとの組み合わせはいずれも望ましい配慮です。",
  },
];
