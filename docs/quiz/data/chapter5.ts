...
export const chapter5: Quiz[] = [
  ...
  },
  {
    ...
    choices: [
      "十分な文字サイズを確保する",
      "見出しに赤系の色を使い、本文との違いを色で強調する",
      "中字以上の太さで線が消えないようにする",
      "細い装飾書体を使い、文字間・行間を詰める",
    ],
    answer: 3,
    explanation: "細い装飾書体は読み取りにくく、文字間・行間を詰めると読みづらさが増します。最も不適切なのは選択肢3。なお選択肢2「見出しを赤系で強調」は一見配慮に見えますが、色だけに頼る強調は色覚特性者や黄変が進んだ高齢者には伝わらないため、太字やサイズ差での強調が本来は望ましい配慮です。",
  },
];
