...
export const chapter6: Quiz[] = [
  ...
  },
  {
    ...
    lesson: "lesson28",
    difficulty: "normal",
    question: "ブランドカラーの制約で見分けにくい色相を変更できない場合、最初に追加すべき手段はどれですか。",
    choices: [
      "色をより鮮やかにする",
      "テキストラベルや形・パターンなど色以外の手がかりを加える",
      "色の数をできるだけ増やして細かく区別する",
      "対象から色覚特性のある人を外して考える",
    ],
    answer: 1,
    explanation: "ブランドカラーを変更できない場面では、テキストラベル・形・パターンなど色以外の手がかりを加えるのが定石です。彩度を上げても色相の混同は解消せず、色数を増やすと逆に区別が難しくなります。設計の対象から特定の人を外すのは色のUDの基本姿勢に反します。",
  },
  {
    id: "q519",
    lesson: "lesson28",
